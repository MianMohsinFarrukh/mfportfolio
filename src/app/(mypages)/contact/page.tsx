    ...
    <div>
      <section className="text-gray-600 body-font relative">
        <div className="container px-5 py-24 mx-auto">
          ...
          <h1 className="sm:text-5xl text-2xl font-medium title-font mb-4 text-indigo-500">CONTACT US</h1>
          ...
          <div className="lg:w-1/2 md:w-2/3 mx-auto">
            <div className="flex flex-wrap -m-2">
              ...
              <div className="p-2 w-full">
                <button className="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">Click</button>
              </div>
              <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                <a className="text-indigo-500">example@email.com</a>
                <p className="leading-normal my-5">49 Smith Stpa.
      ...
      <section className="text-gray-600 body-font relative mb-24">
        <div className="absolute inset-0 bg-gray-300">
          <iframe width="100%" height="100%" title="map" src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=%C4%B0zmir+(My%20Business%20Name)&ie=UTF8&t=&z=14&iwloc=B&output=embed" className="filter: grayscale(1) contrast(1.2) opacity(0.4);"></iframe>
        </div>
